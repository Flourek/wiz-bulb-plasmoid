...
ColumnLayout {
    ...
    // Signal for when warm white values change
    signal warmWhiteChanged(int brightness, int temperature)
        ...
        PlasmaComponents3.Slider {
            ...
            onMoved: {
                if (enabled) {
                    ...
                    warmWhiteChanged(Math.round(warmBrightnessSlider.value), Math.round(value));
                }
            }
        }
    ...
    RowLayout {
        ...
        PlasmaComponents3.Button {
            ...
            onClicked: {
                ...
                warmWhiteChanged(Math.round(warmBrightnessSlider.value), 2200);
            }
        }
        ...
        PlasmaComponents3.Button {
            ...
            onClicked: {
                ...
                warmWhiteChanged(Math.round(warmBrightnessSlider.value), 3000);
            }
        }
        ...
        RowLayout {
            ...
            PlasmaComponents3.Button {
                ...
                onClicked: {
                    ...
                    warmWhiteChanged(Math.round(warmBrightnessSlider.value), 6500);
                }
            }
            
            PlasmaComponents3.Button {
                id: powerButton
                text: appletInterface.wizConnected && appletInterface.bulbPowerState ? "ON" : "OFF"
                ...
                background: Rectangle {
                    color: powerButton.pressed ? 
                           (appletInterface.wizConnected && appletInterface.bulbPowerState ? "#44AA44" : "#AA4444") :
                           (appletInterface.wizConnected && appletInterface.bulbPowerState ? "#55CC55" : "#CC5555")
                    border.color: "#888888"
                    border.width: 1
                    radius: 4
                }
